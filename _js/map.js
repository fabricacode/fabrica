...
function hideMenu() {
    ...
    function W(e, t, n) {
        ...
        return ct.map(c, R, l), ct.isFunction(l.opts.start) && l.opts.start.call(e, l), ct.fx.timer(ct.extend(u, {
            elem: e,
            anim: l,
            queue: l.opts.queue
    ...
    function P(e, t, n) {
        ...
        if (!ct.isEmptyObject(c)) {
            ...
            for (r in c) a = R(f ? d[r] : 0, r, l), r in d || (d[r] = a.start, f && (a.end = a.start, a.start = "width" === r || "height" === r ? 1 : 0))
        }
    }
    ...
    function (e, t) {
        function n(e, t, n, r) {
            ...
            if (F && !r) {
                ...
                if (C.qsa && (!q || !q.test(e))) {
                    if (p = c = R, h = t, m = 9 === s && e, 1 === s && "object" !== t.nodeName.toLowerCase()) {
        ...
        function w(e, t, n, r) {
            var i, o, a, s, u, l = f(e);
            if (!r && 1 === l.length) {
                if (o = l[0] = l[0].slice(0), o.length > 2 && "ID" === (a = o[0]).type && C.getById && 9 === t.nodeType && F && k.relative[o[1].type]) {
            ...
            return A(e, l)(r, t, !F, n, dt.test(e)), n
        }
        var T, C, N, k, E, S, A, j, D, L, H, M, F, q, O, _, $, R = "sizzle" + -new Date,
            W = e.document,
            B = 0,
            P = 0,
            z = r(),
        ...
        S = n.isXML = function (e) {
            ...
            var n = e ? e.ownerDocument || e : W,
                r = n.defaultView;
            return n !== H && 9 === n.nodeType && n.documentElement ? (H = n, M = n.documentElement, F = !S(n), r && r.attachEvent && r !== r.top && r.attachEvent("onbeforeunload", function () {
                L()
                ...
                return typeof n.getElementsByClassName !== V && F ? n.getElementsByClassName(e) : t
            }, O = [], q = [], (C.qsa = vt.test(n.querySelectorAll)) && (o(function (e) {
            ...
            })), (C.matchesSelector = vt.test(_ = M.webkitMatchesSelector || M.mozMatchesSelector || M.oMatchesSelector || M.msMatchesSelector)) && o(function (e) {
                C.disconnectedMatch = _.call(e, "div"), _.call(e, "[s!='']:x"), O.push("!=", ut)
            }), q = q.length && RegExp(q.join("|")), O = O.length && RegExp(O.join("|")), $ = vt.test(M.contains) || M.compareDocumentPosition ? function (e, t) {
                ...
                return r ? 1 & r || !C.sortDetached && t.compareDocumentPosition(e) === r ? e === n || $(W, e) ? -1 : t === n || $(W, t) ? 1 : D ? nt.call(D, e) - nt.call(D, t) : 0 : 4 & r ? -1 : 1 : e.compareDocumentPosition ? -1 : 1
            } : function (e, t) {
                var r, i = 0,
                    o = e.parentNode,
                    a = t.parentNode,
            ...
            if ((e.ownerDocument || e) !== H && L(e), t = t.replace(ht, "='$1']"), !(!C.matchesSelector || !F || O && O.test(t) || q && q.test(t))) try {
                var r = _.call(e, t);
            ...
            var r = k.attrHandle[n.toLowerCase()],
                i = r && Q.call(k.attrHandle, n.toLowerCase()) ? r(e, n, !F) : t;
            return i === t ? C.attributes || !F ? e.getAttribute(n) : (i = e.getAttributeNode(n)) && i.specified ? i.value : null : i
        }, n.error = function (e) {
            ...
            var t, n = [],
                r = 0,
                i = 0;
            if (U = !C.detectDuplicates, D = !C.sortStable && e.slice(0), e.sort(G), U) {
            ...
            filter: {
                    ...
                    return 1 === r && 0 === i ? function (e) {
                        ...
                        if (g) {
                            ...
                            if (h = [a ? g.firstChild : g.lastChild], a && v) {
                                for (c = g[R] || (g[R] = {}), l = c[e] || [], d = l[0] === B && l[1], f = l[0] === B && l[2], p = d && g.childNodes[d]; p = ++d && p && p[m] || (f = d = 0) || h.pop();)
                                    if (1 === p.nodeType && ++f && p === t) {
                                        c[e] = [B, d, f];
                                        break
                                    }
                            } else if (v && (l = (t[R] || (t[R] = {}))[e]) && l[0] === B) f = l[1];
                            else
                                for (;
                                    (p = ++d && p && p[m] || (f = d = 0) || h.pop()) && ((s ? p.nodeName.toLowerCase() !== y : 1 !== p.nodeType) || !++f || (v && ((p[R] || (p[R] = {}))[e] = [B, f]), p !== t)););
                ...
                PSEUDO: function (e, t) {
                    ...
                    return o[R] ? o(t) : o.length > 1 ? (r = [e, e, "", t], k.setFilters.hasOwnProperty(e.toLowerCase()) ? i(function (e, n) {
        ...
        p.prototype = k.filters = k.pseudos, k.setFilters = new p, A = n.compile = function (e, t) {
            var n, r = [],
                ...
                o = X[e + " "];
            if (!o) {
                for (t || (t = f(e)), n = t.length; n--;) o = v(t[n]), o[R] ? r.push(o) : i.push(o);
                o = X(e, b(i, r))
            }
            return o
        }, C.sortStable = R.split("").sort(G).join("") === R, C.detectDuplicates = U, L(), C.sortDetached = o(function (e) {
    ...
    ct.Callbacks = function (e) {
        ...
        return t.ownLast = "0" !== c, ct(function () {
            ...
            a && (n = Q.createElement("div"), n.style.cssText = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px", a.appendChild(n).appendChild(p), p.innerHTML = "<table><tr><td></td><td>t</td></tr></table>", i = p.getElementsByTagName("td"), i[0].style.cssText = "padding:0;margin:0;border:0;display:none", l = 0 === i[0].offsetHeight, i[0].style.display = "", i[1].style.display = "none", t.reliableHiddenOffsets = l && 0 === i[0].offsetHeight, p.innerHTML = "", p.style.cssText = "box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%;", ct.swap(a, null != a.style.zoom ? {
                ...
                width: "4px"
            }).width, r = p.appendChild(Q.createElement("div")), r.style.cssText = p.style.cssText = o, r.style.marginRight = r.style.width = "0", p.style.width = "1px", t.reliableMarginRight = !parseFloat((e.getComputedStyle(r, null) || {}).marginRight)), typeof p.style.zoom !== V && (p.innerHTML = "", p.style.cssText = o + "width:1px;padding:1px;display:inline;zoom:1", t.inlineBlockNeedsLayout = 3 === p.offsetWidth, p.style.display = "block", p.innerHTML = "<div></div>", p.firstChild.style.width = "5px", t.shrinkWrapBlocks = 3 !== p.offsetWidth, t.inlineBlockNeedsLayout && (a.style.zoom = 1)), a.removeChild(n), n = p = i = r = null)
        }), n = o = a = s = r = i = null, t
    }({});
    var Et = /(?:\{[\s\S]*\}|\[[\s\S]*\])$/,
        St = /([A-Z])/g;
    ...
    ct.fn.extend({
        ...
        attr: function (e, n, r) {
            ...
            return e && 3 !== a && 8 !== a && 2 !== a ? typeof e.getAttribute === V ? ct.prop(e, n, r) : (1 === a && ct.isXMLDoc(e) || (n = n.toLowerCase(), i = ct.attrHooks[n] || (ct.expr.match.bool.test(n) ? jt : At)), r === t ? i && "get" in i && null !== (o = i.get(e, n)) ? o : (o = ct.find.attr(e, n), null == o ? t : o) : null !== r ? i && "set" in i && (o = i.set(e, r, n)) !== t ? o : (e.setAttribute(n, r + ""), r) : (ct.removeAttr(e, n), t)) : void 0
        },
        removeAttr: function (e, t) {
            var n, r, i = 0,
                o = t && t.match(ft);
            if (o && 1 === e.nodeType)
                for (; n = o[i++];) r = ct.propFix[n] || n, ct.expr.match.bool.test(n) ? Ot && qt || !Ft.test(n) ? e[r] = !1 : e[ct.camelCase("default-" + n)] = e[r] = !1 : ct.attr(e, n, ""), e.removeAttribute(qt ? n : r)
        },
        attrHooks: {
            type: {
                set: function (e, t) {
        ...
        set: function (e, t, n) {
            return t === !1 ? ct.removeAttr(e, n) : Ot && qt || !Ft.test(n) ? e.setAttribute(!qt && ct.propFix[n] || n, n) : e[ct.camelCase("default-" + n)] = e[n] = !0, n
        }
    }, ct.each(ct.expr.match.bool.source.match(/\w+/g), function (e, n) {
        var r = ct.expr.attrHandle[n] || ct.find.attr;
        ct.expr.attrHandle[n] = Ot && qt || !Ft.test(n) ? function (e, n, i) {
    ...
    ct.event = {
        ...
        add: function (e, n, r, i, o) {
            ...
            if (y) {
                ...
                }, p.elem = e), n = (n || "").match(ft) || [""], u = n.length; u--;) a = Bt.exec(n[u]) || [], h = g = a[1], m = (a[2] || "").split(".").sort(), h && (c = ct.event.special[h] || {}, h = (o ? c.delegateType : c.bindType) || h, c = ct.event.special[h] || {}, f = ct.extend({
                    type: h,
                    origType: g,
                    data: i,
                    handler: r,
        ...
        remove: function (e, t, n, r, i) {
            ...
            if (g && (c = g.events)) {
                for (t = (t || "").match(ft) || [""], l = t.length; l--;)
                    if (s = Bt.exec(t[l]) || [], d = m = s[1], h = (s[2] || "").split(".").sort(), d) {
        ...
        trigger: function (n, r, i, o) {
            ...
            if (u = p = i = i || Q, 3 !== i.nodeType && 8 !== i.nodeType && !Wt.test(h + ct.event.triggered) && (h.indexOf(".") >= 0 && (m = h.split("."), h = m.shift(), m.sort()), s = 0 > h.indexOf(":") && "on" + h, n = n[ct.expando] ? n : new ct.Event(h, "object" == typeof n && n), n.isTrigger = o ? 2 : 3, n.namespace = m.join("."), n.namespace_re = n.namespace ? RegExp("(^|\\.)" + m.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, n.result = t, n.target || (n.target = i), r = null == r ? [n] : ct.makeArray(r, [n]), c = ct.event.special[h] || {}, o || !c.trigger || c.trigger.apply(i, r) !== !1)) {
                if (!o && !c.noBubble && !ct.isWindow(i)) {
                    for (l = c.delegateType || h, Wt.test(l + h) || (u = u.parentNode); u; u = u.parentNode) d.push(u), p = u;
    ...
    sn.optgroup = sn.option, sn.tbody = sn.tfoot = sn.colgroup = sn.caption = sn.thead, sn.th = sn.td, ct.fn.extend({
        ...
        html: function (e) {
            return ct.access(this, function (e) {
                ...
                if (!("string" != typeof e || en.test(e) || !ct.support.htmlSerialize && Vt.test(e) || !ct.support.leadingWhitespace && Yt.test(e) || sn[(Jt.exec(e) || ["", ""])[1].toLowerCase()])) {
                    e = e.replace(Qt, "<$1></$2>");
                    try {
        ...
        clone: function (e, t, n) {
            ...
            if (ct.support.html5Clone || ct.isXMLDoc(e) || !Vt.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (ln.innerHTML = e.outerHTML, ln.removeChild(o = ln.firstChild)), !(ct.support.noCloneEvent && ct.support.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || ct.isXMLDoc(e)))
        ...
        buildFragment: function (e, t, n, r) {
            for (var i, o, a, s, u, l, c, p = e.length, f = d(t), h = [], m = 0; p > m; m++)
                ...
                for (s = s || f.appendChild(t.createElement("div")), u = (Jt.exec(o) || ["", ""])[1].toLowerCase(), c = sn[u] || sn._default, s.innerHTML = c[1] + o.replace(Qt, "<$1></$2>") + c[2], i = c[0]; i--;) s = s.lastChild;
        ...
        cleanData: function (e, t) {
            for (var n, r, i, o, a = 0, s = ct.expando, u = ct.cache, l = ct.support.deleteExpando, c = ct.event.special; null != (n = e[a]); a++)
                if ((t || ct.acceptData(n)) && (i = n[s], o = i && u[i])) {
                    ...
                    u[i] && (delete u[i], l ? delete n[s] : typeof n.removeAttribute !== V ? n.removeAttribute(s) : n[s] = null, tt.push(i))
                }
        },
        _evalUrl: function (e) {
            return ct.ajax({
    ...
    Ln = Bn.exec(Hn.toLowerCase()) || [], ct.fn.load = function (e, n, r) {
        ...
        ajax: function (e, n) {
            ...
            var i, o, a, s, u, l, c, p, f = ct.ajaxSetup({}, n),
                ...
                T = {
                    ...
                    getResponseHeader: function (e) {
                        ...
                        if (2 === x) {
                            if (!p)
                                for (p = {}; t = _n.exec(s);) p[t[1].toLowerCase()] = t[2];
                            t = p[e.toLowerCase()]
                        }
            ...
            if (m.promise(T).complete = g.add, T.success = T.done, T.error = T.fail, f.url = ((e || f.url || Hn) + "").replace(qn, "").replace(Wn, Ln[1] + "//"), f.type = n.method || n.type || f.method || f.type, f.dataTypes = ct.trim(f.dataType || "*").toLowerCase().match(ft) || [""], null == f.crossDomain && (i = Bn.exec(f.url.toLowerCase()), f.crossDomain = !(!i || i[1] === Ln[1] && i[2] === Ln[2] && (i[3] || ("http:" === i[1] ? "80" : "443")) === (Ln[3] || ("http:" === Ln[1] ? "80" : "443")))), f.data && f.processData && "string" != typeof f.data && (f.data = ct.param(f.data, f.traditional)), H(zn, f, n, T), 2 === x) return T;
            l = f.global, l && 0 === ct.active++ && ct.event.trigger("ajaxStart"), f.type = f.type.toUpperCase(), f.hasContent = !Rn.test(f.type), a = f.url, f.hasContent || (f.data && (a = f.url += (Fn.test(a) ? "&" : "?") + f.data, delete f.data), f.cache === !1 && (f.url = On.test(a) ? a.replace(On, "$1_=" + Mn++) : a + (Fn.test(a) ? "&" : "?") + "_=" + Mn++)), f.ifModified && (ct.lastModified[a] && T.setRequestHeader("If-Modified-Since", ct.lastModified[a]), ct.etag[a] && T.setRequestHeader("If-None-Match", ct.etag[a])), (f.data && f.hasContent && f.contentType !== !1 || n.contentType) && T.setRequestHeader("Content-Type", f.contentType), T.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + Xn + "; q=0.01" : "") : f.accepts["*"]);
    ...
    ct.ajaxSetup({
        ...
        return u || "jsonp" === n.dataTypes[0] ? (o = n.jsonpCallback = ct.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback, u ? n[u] = n[u].replace(Vn, "$1" + o) : n.jsonp !== !1 && (n.url += (Fn.test(n.url) ? "&" : "?") + n.jsonp + "=" + o), n.converters["script json"] = function () {
            return s || ct.error(o + " was not called"), s[0]
        }, n.dataTypes[0] = "json", a = e[o], e[o] = function () {
            s = arguments
        }, i.always(function () {
            e[o] = a, n[o] && (n.jsonpCallback = r.jsonpCallback, Gn.push(o)), s && ct.isFunction(a) && a(s[0]), s = a = t
        }), "script") : t
    });
    var Yn, Qn, Jn = 0,
    ...
    } : O, Qn = ct.ajaxSettings.xhr(), ct.support.cors = !! Qn && "withCredentials" in Qn, Qn = ct.support.ajax = !! Qn, Qn && ct.ajaxTransport(function (n) {
                    ...
                    u.send(n.hasContent && n.data || null), r = function (e, i) {
                        ...
                        try {
                            if (r && (i || 4 === u.readyState))
                                if (r = t, a && (u.onreadystatechange = ct.noop, Kn && delete Yn[a]), i) 4 !== u.readyState && u.abort();
                                else {
                        ...
                        p && o(s, c, p, l)
                    }, n.async ? 4 === u.readyState ? setTimeout(r) : (a = ++Jn, Kn && (Yn || (Yn = {}, ct(e).unload(Kn)), Yn[a] = r), u.onreadystatechange = r) : r()
                },
                abort: function () {
                    r && r(t, !0)
                }
    ...
    ct.Animation = ct.extend(W, {
        ...
        var n, r, i = {
            ...
            a = o && o.ownerDocument;
        return a ? (n = a.documentElement, ct.contains(n, o) ? (typeof o.getBoundingClientRect !== V && (i = o.getBoundingClientRect()), r = X(a), {
    ...
    var t = {
        init: function (t) {
            var n = e.extend({
                ...
                r = {}, i = [];
            e(this), n.imgURI = "http://maps.googleapis.com/maps/api/staticmap?", r.center = "Brussels Belgium", r.zoom = "5", r.size = screen.width + "x" + 480, r.scale = window.devicePixelRatio ? window.devicePixelRatio : 1, r.maptype = "roadmap", r.sensor = !1, n.settings = r, e(this).attr("data-center") && (n.settings.center = e(this).attr("data-center").replace(/ /gi, "+")), e(this).attr("data-zoom") && (n.settings.zoom = parseInt(e(this).attr("data-zoom"))), e(this).attr("data-maptype") && (n.settings.zoom = e(this).attr("data-maptype")), n.showMarker && i.push({
                label: "A",
                position: r.center
            }), n.markers = i, e(this).data("options", n), screen.width < n.deviceWidth ? e(this).mobileGmap("showImage") : e(this).mobileGmap("showMap")
        },
        showMap: function () {
            var t = e(this).data("options"),
                n = new google.maps.Geocoder,
                r = (new google.maps.LatLng(-34.397, 150.644), {}),
                i = e(this).get(0);
            n.geocode({
                address: t.settings.center.replace(/\+/gi, " ")
            }, function (e, n) {
                if (n == google.maps.GeocoderStatus.OK) {
                    r = {
                        zoom: parseInt(t.settings.zoom, 10),
                        center: e[0].geometry.location,
                        mapTypeId: t.settings.maptype
                    };
                    var o = new google.maps.Map(i, r);
        ...
        showImage: function () {
            var t = [],
                ...
                i = e(this).data("options"),
                o = 0,
                a = [];
            for (var s in i.settings) t.push(s + "=" + i.settings[s]);
            if (i.markers.length)
                for (var u = []; o < i.markers.length; o++) {
                    u = [];
                    for (var l in i.markers[o]) "position" == l ? u.push(i.markers[o][l]) : u.push(l + ":" + i.markers[o][l]);
                    a.push("&markers=" + u.join("%7C"))
                }
            n.src = i.imgURI + t.join("&") + a.join(""), r.href = "http://maps.google.com/maps?q=" + i.settings.center, r.appendChild(n), e(this).empty().append(r)
        }
    };
    e.fn.mobileGmap = function (n) {
        return t[n] ? t[n].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof n && n ? (e.error("Method " + n + " does not exist on jQuery.mobileGmap"), void 0) : t.init.apply(this, arguments)
    }
}(this.jQuery),
/*!
 * FitText.js 1.1
...
$(document).ready(function () {
    ...
    $(".gmap").mobileGmap(), $("#headline").fitText(2.2, {
        minFontSize: "10px",
        maxFontSize: "42px"
    });
    var e = [{
