		...
		<div class='page black'>
			...
			if(isset($_SESSION["loggedin"]) && $_SESSION["position"] == "admin"){
				if(isset($_POST["username"])){
					...
					$nametest = mysql_query("SELECT id FROM person WHERE username='{$username}'");
					if(mysql_num_rows($nametest) > 0){
						echo "<font style='color:#ff0000;'>The username \"{$username}\" is already being used. Please choose another.</font>";
